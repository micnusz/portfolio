...
const Footer = () => {
  ...
  return (
    <footer className="flex h-screen md:px-20 md:py-6 bg-muted-foreground text-background ">
      <div className="w-1/2">
        <Button className="p-8" variant="link">
          <span className="scroll-m-20 text-3xl sm:text-4xl md:text-5xl font-semibold first:mt-0 leading-none inline-block border-b pb-2">
            Contact Me
          </span>
        </Button>
      </div>
